                        ...
                        <div class="col-lg-4 col-md-4 col-12">
                            <div class="top-middle">
                                <ul class="useful-links">
                                    ...
                                    <li>
                                        <a href="{{ asset('about-us.html') }}">About Us</a>
                                    </li>
                                    <li>
                        ...
                        <div class="slider-head">
                            ...
                            <div class="hero-slider">
                                ...
                                <div
                                    class="single-slider"
                                    style="
                                        background-image: url({{ asset('assets/images/hero/slider-bg1.jpg') }});
                                    "
                                >
                                    <div class="content">
                                        <h2>
                                            <span
                                                >No restocking fee ($35
                                                savings)</span
                                            >
                                            M75 Sport Watch
                                        </h2>
                                ...
                                <div
                                    class="single-slider"
                                    style="
                                        background-image: url({{ asset('assets/images/hero/slider-bg2.jpg') }});
                                    "
                                >
                                    <div class="content">
                                        <h2>
                        ...
                        <div class="row">
                            ...
                            >
                                ...
                                <div
                                    ...
                                    style="
                                        background-image: url({{ asset('assets/images/hero/slider-bnr.jpg') }});
                                    "
                                >
                                    <div class="content">
                                        <h2>
                        ...
                        <div class="inner">
                            <div class="content">
                                ...
                                <p class="wow fadeInUp" data-wow-delay=".6s">
                                    Please, purchase full version of the
                                    template to get all pages,<br />
                ...
                <div class="row">
                    <div class="col-lg-6 col-md-6 col-12">
                        <div
                            class="single-banner"
                            style="
                                background-image: url({{ asset('assets/images/banner/banner-1-bg.jpg') }});
                            "
                        >
                            <div class="content">
                    ...
                    <div class="col-lg-6 col-md-6 col-12">
                        <div
                            ...
                            style="
                                background-image: url({{ asset('assets/images/banner/banner-2-bg.jpg') }});
                            "
                        >
                            <div class="content">
                        ...
                        <div class="row">
                            <div class="col-lg-3 col-md-4 col-12">
                                <div class="footer-logo">
                                    <a href="index.html">
                                        <img
                                            src="{{ asset('assets/images/logo/white-logo.svg') }}"
                                            alt="#"
                                        />
                                    </a>
                                </div>
                        ...
                        <div class="row align-items-center">
                            <div class="col-lg-4 col-12">
                                <div class="payment-gateway">
                                    <span>We Accept:</span>
                                    <img
                                        src="{{ asset('assets/images/footer/credit-cards-footer.png') }}"
                                        alt="#"
                                    />
                                </div>
                            </div>
